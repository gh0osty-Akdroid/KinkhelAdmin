...
const ForgetPart = ({ setPhone, log_phone, setMode }) => {
  ...
  const handleLogin = (e) => {
    ...
    adminUrl.post(`/forget-password`, body).then((res) => {
  ...
  const handleOtp = (e) => {
    ...
    adminUrl.post(`/reset-password/${log_phone}`, body).then((res) => {
...
const ChangePassword = ({ log_phone }) => {
  ...
  const handleChangePassword = (e) => {
    e.preventDefault()
    adminUrl.post(`/new-password/${log_phone}`, { password: password }).then(res => {
