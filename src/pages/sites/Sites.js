...
import { adminTokenUrl, adminUrl, ImgUrl } from '../../Urls';
...
function Sites() {
  ...
  useEffect(() => {
    ...
    adminTokenUrl().get('/site-config').then((data) => {
  ...
  return (
    <div className="m-2 md:m-10 mt-18 p-2 md:p-10 dark:text-gray-200 dark:bg-secondary-dark-bg rounded-3xl">
      <Header category="Sites" title="List of Sites" />
              ...
              <tbody>
                {
                  data.map((e, i) =>
                    <tr key={i} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      <td className="py-4 px-6">
                        <img src={`${ImgUrl}${e.logo}`} width={"50px"}/>
                      </td>
                      <td className="py-4 px-6">
